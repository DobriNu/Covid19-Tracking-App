...
public class CovidCountryAdapter extends RecyclerView.Adapter<CovidCountryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CovidCountryAdapter.ViewHolder holder, int position) {
        ...
        holder.tvTotalCa.setText(covidCountry.getmCases());
        holder.tvCountryName.setText(covidCountry.getmCovidCountry());

        //Glide
        Glide.with(context).load(covidCountry.getmFlags()).
                apply(new RequestOptions().override(240,160)).into(holder.imgCountryFlag);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvTotalCa, tvCountryName;
        ImageView imgCountryFlag;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvTotalCa = itemView.findViewById(R.id.tvTotalCa);
